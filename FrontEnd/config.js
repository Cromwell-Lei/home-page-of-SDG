...
(function () {
    ...
    const DEV_CONFIG = {
        ...
        // 认证相关 API 基础路径
        API_AUTH_BASE: 'http://localhost:8080/api/auth',
        // 管理员 API 基础路径（与 API_BASE 相同，为保持语义清晰）
        API_ADMIN_BASE: 'http://localhost:8080/api'
    };

    // 生产环境配置（示例）
    const PROD_CONFIG = {
        API_BASE: 'https://your-production-domain.com/api',
        API_AUTH_BASE: 'https://your-production-domain.com/api/auth',
        API_ADMIN_BASE: 'https://your-production-domain.com/api'
    };
